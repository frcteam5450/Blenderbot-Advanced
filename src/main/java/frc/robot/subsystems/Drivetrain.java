...
public class Drivetrain extends Subsystem {
  ...
  public void reportStats() {
    SmartDashboard.putNumber("Left Motor 1 (0)", leftMotor1.getStatorCurrent());
    SmartDashboard.putNumber("Left Motor 2 (1)", leftMotor2.getStatorCurrent());
    SmartDashboard.putNumber("Right Motor 1 (2)", rightMotor1.getStatorCurrent());
    SmartDashboard.putNumber("Right Motor 2 (3)", rightMotor2.getStatorCurrent());

    if (leftMotor1.getStatorCurrent() > RobotMap.motorWarningCurrent) 
    print("Motor " + leftMotor1.getBaseID() + " is > " + RobotMap.motorWarningCurrent + " Amps!");

    if (leftMotor2.getStatorCurrent() > RobotMap.motorWarningCurrent) 
    print("Motor " + leftMotor2.getBaseID() + " is > " + RobotMap.motorWarningCurrent + " Amps!");
    
    if (rightMotor1.getStatorCurrent() > RobotMap.motorWarningCurrent) 
    print("Motor " + rightMotor1.getBaseID() + " is > " + RobotMap.motorWarningCurrent + " Amps!");

    if (rightMotor2.getStatorCurrent() > RobotMap.motorWarningCurrent) 
